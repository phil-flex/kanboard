...
return array(
    ...
    'month' => '月',
    'week' => '周',
    'day' => '日',    // 'Reorder this column by due date (ASC)' => '',
    'Automatically set the due date when the task is moved away from a specific column' => '當任務離開指定欄目時自動設置到期時間',
    'No other projects found.' => '未找到其它項目。',
    'Please choose a project you want to copy the tasks from.' => '請選擇將要復制的任務所屬的項目。',
    'Import Tasks' => '引入任務',
    'Copy' => '復制',
    'Tasks copied successfully.' => '任務復制成功。',
    'Unable to copy tasks.' => '無法復制任務。',
);
